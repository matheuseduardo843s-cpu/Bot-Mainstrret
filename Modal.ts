...
import { ButtonInteraction, CacheType, Collection, ModalMessageModalSubmitInteraction, ModalSubmitInteraction } from "discord.js";
...
export class Modal<C extends CacheType = CacheType, M extends boolean = boolean>{
    run(interaction: ButtonInteraction<CacheType>) {
